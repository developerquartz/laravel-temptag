          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><router-link :to="{name: 'admin_products_list'}">Products</router-link></li>
                            ...
                            <form @submit.prevent="updateCustomer">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input id="product_name" type="text" class="form-control" v-model="product.product_name" required autofocus autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <tr v-for='(product_price_json_1, index) in product_price_json' :key="index">                            
                                        <td>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <img v-if="product.product_feature_image_old!='' && product.product_feature_image_old != 'NULL'" :src="'/storage/uploads/products/'+product.product_feature_image_old" width="200px">
                                        <img v-else :src="'/assets/admin/images/no-image-available_1.png'" width="200px">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="product_feature_image" class="form-label">Image</label>
                                        <input type="file" class="form-control" v-on:change="onChange($event, 'product_feature_image')" >
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <img v-if="product.additional_image1_old!='' && product.additional_image1_old != 'NULL'" :src="'/storage/uploads/products/'+product.additional_image1_old" width="200px">
                                        <img v-else :src="'/assets/admin/images/no-image-available_1.png'" width="200px">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="additional_image1" class="form-label">Section 1 Image</label>
                                        <input type="file" class="form-control" v-on:change="onChange($event, 'additional_image1')">
...
export default {
    ...
    methods: {
        ...
        updateCustomer(e) {
            e.preventDefault();
            // console.log(this.product_price_json);exit;
            if(this.product.category_id=='Select Category'){
                ...
                data.append('product_feature_image_old', this.product.product_feature_image_old);

                data.append('additional_image1', this.product.additional_image1);
                data.append('additional_image1_old', this.product.additional_image1_old);

                axios.post(`/api/products/update/${this.$route.params.id}`, data, config)
