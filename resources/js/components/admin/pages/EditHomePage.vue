            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card card-info">
                        <div class="card-header">Edit Home Page</div>
                        <div class="card-body">
                            <form @submit.prevent="updateCustomer">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <h2>How It Work Section</h2>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="how_it_work_section_title" class="form-label">Top Title</label>
                                        <input id="how_it_work_section_title" type="text" class="form-control" v-model="page.page_content[0]['how_it_work_section_title'][0]['title']" required autofocus autocomplete="off">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <!-- {{page.how_it_work_section_image3}} ||
                                        {{page.how_it_work_section_image3_old}} -->
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="buy_now_section_title" class="form-label">Top Title</label>
                                        <input id="buy_now_section_title" type="text" class="form-control" v-model="page.page_content[0]['buy_now_section_title'][0]['title']" required autofocus autocomplete="off">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-md-12">
                                      <label for="product_id" class="form-label">Select Product for home page</label>
                                      <!-- <input type="text" v-model="product.category_id" class="form-control" id="category_id" required> -->
                                      <select class='form-control' v-model="page.page_content[0]['product_ids'][0]['product_id']" :required="true">
...
export default {
    ...
    created() {
        ...
        //
        this.get_edit_homepage();      

        // Get all products for selecting display on home page
    ...
    methods: {
        onChange(e,column_name) {
            ...
            if(column_name=="how_it_work_section_image3"){
                ...
                // this.page.how_it_work_section_image3_old = URL.createObjectURL(this.page.how_it_work_section_image3);
                // console.log(this.page.how_it_work_section_image3_old);
                // console.log(this.fileName=this.page.how_it_work_section_image3.name);
            }
        },
        updateCustomer(e) {
            e.preventDefault();
            if(this.page.page_content[0]['product_ids'][0]['product_id']=='Select Category'){
        ...
        get_edit_homepage(){
            ...
            .then(response => {
                ...
                this.page.page_feature_image = response.data.data.page.page_feature_image;
                this.page.page_feature_image_old = response.data.data.page.page_feature_image;

                this.page.page_title_background_image = response.data.data.page.page_title_background_image;
                ...
                this.page.features_section_image = this.page.additional_images.features_section_image;
                this.page.features_section_image_old = this.page.additional_images.features_section_image;
                
                this.page.how_it_work_section_image1 = this.page.additional_images.how_it_work_section_image1;
                this.page.how_it_work_section_image1_old = this.page.additional_images.how_it_work_section_image1;

                this.page.how_it_work_section_image2 = this.page.additional_images.how_it_work_section_image2;
                this.page.how_it_work_section_image2_old = this.page.additional_images.how_it_work_section_image2;

                this.page.how_it_work_section_image3 = this.page.additional_images.how_it_work_section_image3;
                ...
                console.log(this.page.how_it_work_section_image3+' aaa '+this.page.how_it_work_section_image3_old);
            })
            .catch(function (error) {
                console.error(error);
            });
