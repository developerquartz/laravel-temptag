                        ...
                        <form @submit.prevent="updateCustomer">
                            ...
                            <div class="form-group row">  
                              <div class="col-md-6">
                                ...
                                <!-- <datepicker  v-model="user.njvmc_expiration_date" input-class="form-control" id="njvmc_expiration_date"  @onChange="customDateFormat" input-attr="{required: 'true'}"></datepicker> -->
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="text" v-model="user.fax" class="form-control" id="fax" required>
                              </div>
                            </div>
                            <div class="form-group row">
                              <div class="col-md-12">
...
export default {
    ...
    methods: {
        ...
        updateCustomer() {
            ...
            axios.post(`/api/users/update/${this.$route.params.id}`, data, config)
